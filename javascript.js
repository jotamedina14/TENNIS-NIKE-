...
function loadEventListeners() {
    ...
    emptyCartButton.addEventListener('click', emptyCart); // Agregar esta línea
}
...
function emptyCart() {
    // Vaciar el arreglo de elementos comprados
    buyThings = [];
    // Reiniciar el total de la tarjeta
    totalCard = 0;
    ...
    priceTotal.innerHTML = 0;
    // Establecer el número de productos en 0
    cantidadProduct.innerHTML = 0; // Agregar esta línea
    // Actualizar el HTML del carrito (que ahora estará vacío)
    loadHtml();
}
